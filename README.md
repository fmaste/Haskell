# [Haskell](http://www.haskell.org/), an advanced, purely functional programming language [^1] [^2]
...
A ***mixture of quick reference guide and Haskell tutorial*** full of external references.
